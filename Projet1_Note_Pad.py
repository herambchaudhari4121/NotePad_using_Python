...
def about():
    showinfo("Notepad", "Notepad by ADARSH SUNIL MASKAR")
...
if __name__ == "__main__":
    ...
    # Adding TextArea Of Writing Every Thing
...
# *********************** File Menu Start****************
    ...
    # Lets Create a Menu Bar Like File Edit and Other
    MenuBar = Menu(root)
